...
<body>
		...
		<div id="proBody">
			<div id="proLeft">
				<ul id="proTitle">
					<li class="row1">ddddd소개영상및 사진등록</li>
					<li class="row2">프로젝트 스토리</li>
			...
			<div id="proMid">		
				<form>				
					...
					<!-- 스토리 -->
					<textarea id="content" name="content">dddddd</textarea>
					...
					<div class="inputData row3">
						<!-- 교환환불 정책 -->
						<textarea style="resize:none" name="proRefund" id="proRefund"></textarea>
					</div>
					<!-- 저장하기 and 다음단계로 -->
