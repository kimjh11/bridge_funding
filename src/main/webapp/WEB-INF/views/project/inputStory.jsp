...
<body>
		...
		<div id="proBody">
			<div id="proLeft">
				<ul id="proTitle2">
					<li class="row1">소개영상 등록<br/><br/><br/><span class="ex2">url 입력후 등록 버튼 클릭시 정상적인 url주소면 영상이 나옵니다.</span></li>
			...
			<div id="proMid">		
				<form>				
					<div class="inputData row1">
						<!-- 소개영상 및 사진등록 -->
						<input type="text" name="proTitle" id="proTitle"/><input type="button" value="url등록" id="titleBtn"/>
						<iframe id="myFrame" width="100%" height="80%" src="" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
					</div>
					...
					<div class="inputData row3">
						<!-- 교환환불 정책 -->
						<textarea style="resize:none" name="proRefund" id="proRefund">
