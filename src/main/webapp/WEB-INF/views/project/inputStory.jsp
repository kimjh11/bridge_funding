			...
			<div id="proMid">		
				<form action="/bridge/saveStory" id="frm" method="get">
					...
					<div class="inputData row1">
						<!-- 소개영상 및 사진등록 -->
						<input type="text" name="proTitle" id="proTitle" value="${vo.proTitle }"/><input type="button" value="urlCheck" id="titleBtn"/>
					...
					<div class="inputData row3">
						<!-- 교환환불 정책 -->
						<textarea style="resize:none" name="proRefund" id="proRefund">${vo.proRefund }</textarea>
					</div>
					<!-- 저장하기 and 다음단계로 -->
